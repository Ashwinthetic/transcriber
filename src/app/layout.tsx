...
export const metadata: Metadata = {
  title: "HHGOA | Speech to Text Content Agent",
  description: "High-performance Speech-to-Text and voice content agent powered by HHGOA",
  icons: {
    icon: "/assets/hhgoa/logo.png",
  },
};
